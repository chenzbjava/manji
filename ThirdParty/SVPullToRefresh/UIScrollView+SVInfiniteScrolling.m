...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        //Modify by zhuhao at 20131010
        UILabel * nomalLable = [[UILabel alloc] init];
        [nomalLable setFrame:frame];
        ...
        [nomalLable setTextColor:[UIColor grayColor]];
        ...
        [loadLabel setTextColor:[UIColor grayColor]];
